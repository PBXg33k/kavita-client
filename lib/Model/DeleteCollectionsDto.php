...
/**
 * DeleteCollectionsDto Class Doc Comment
 *
 * @category Class
 * @package  Pbxg33k\KavitaClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteCollectionsDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteCollectionsDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['collection_ids'] === null) {
            $invalidProperties[] = "'collection_ids' can't be null";
        }
