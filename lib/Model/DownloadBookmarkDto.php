...
/**
 * DownloadBookmarkDto Class Doc Comment
 *
 * @category Class
 * @package  Pbxg33k\KavitaClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DownloadBookmarkDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DownloadBookmarkDto';
    ...
    protected static $swaggerTypes = [
        'bookmarks' => '\Pbxg33k\KavitaClient\Model\BookmarkDto[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bookmarks'] === null) {
            $invalidProperties[] = "'bookmarks' can't be null";
        }
     ...
     * Sets bookmarks
     *
     * @param \Pbxg33k\KavitaClient\Model\BookmarkDto[] $bookmarks bookmarks
     *
     * @return $this
     */
