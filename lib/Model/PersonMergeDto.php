...
/**
 * PersonMergeDto Class Doc Comment
 *
 * @category Class
 * @package  Pbxg33k\KavitaClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PersonMergeDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PersonMergeDto';
    ...
    {
        $this->container['dest_id'] = isset($data['dest_id']) ? $data['dest_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dest_id'] === null) {
            $invalidProperties[] = "'dest_id' can't be null";
        }
        if ($this->container['src_id'] === null) {
            $invalidProperties[] = "'src_id' can't be null";
        }
    ...
    {
        return $this->container['dest_id'];
    }

    /**
     * Sets dest_id
     *
     * @param int $dest_id dest_id
     *
     * @return $this
     */
    public function setDestId($dest_id)
    {
        $this->container['dest_id'] = $dest_id;
