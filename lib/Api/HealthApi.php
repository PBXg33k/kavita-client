...
class HealthApi
{
     ...
     * @return string
     */
    public function apiHealthGet()
    {
        list($response) = $this->apiHealthGetWithHttpInfo();
        return $response;
    }
     ...
     */
    public function apiHealthGetWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->apiHealthGetRequest();
     ...
     */
    public function apiHealthGetAsync()
    {
        return $this->apiHealthGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiHealthGetAsyncWithHttpInfo()
    {
        $returnType = 'string';
        $request = $this->apiHealthGetRequest();
     ...
     */
    protected function apiHealthGetRequest()
    {
