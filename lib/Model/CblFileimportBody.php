...
/**
 * CblFileimportBody Class Doc Comment
 *
 * @category Class
 * @package  Pbxg33k\KavitaClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CblFileimportBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Cbl_fileimport_body';
    ...
    {
        $this->container['cbl_file'] = isset($data['cbl_file']) ? $data['cbl_file'] : null;
    }
     ...
     * @return string
     */
    public function getCblFile()
    {
        return $this->container['cbl_file'];
    }

    /**
     * Sets cbl_file
     *
     * @param string $cbl_file cbl_file
     *
     * @return $this
     */
    public function setCblFile($cbl_file)
    {
        $this->container['cbl_file'] = $cbl_file;
